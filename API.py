...
def format_nomination_votes(data):
    ...
    for vote in data['results']['votes']: 
        ...
        yes = data['results']['votes'][0]['democratic']['yes']

        no = data['results']['votes'][0]['democratic']['no']

        present = data['results']['votes'][0]['democratic']['present']

        not_voting = data['results']['votes'][0]['democratic']['not_voting']
